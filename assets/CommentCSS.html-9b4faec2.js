import{_ as n,o as s,c as a,e}from"./app-abf5995e.js";const t={},p=e(`<h1 id="公共样式" tabindex="-1"><a class="header-anchor" href="#公共样式" aria-hidden="true">#</a> 公共样式</h1><details class="custom-container details"><summary>点击查看代码</summary><div class="language-scss line-numbers-mode" data-ext="scss"><pre class="language-scss"><code><span class="token comment">// 单行文本省略</span>
